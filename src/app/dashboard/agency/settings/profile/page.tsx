...
export default function ProfilePage() {
  ...
  const [formData, setFormData] = useState({
    name: 'Agência Global Mídia',
    slogan: 'Estratégia e Performance de Ponta a Ponta',
    category: 'Full Service',
    description: 'Especializada em planejamento 360º, compra de mídia e branded content. Ajudamos marcas a escalarem seus resultados através de dados e criatividade.',
    audienceType: 'B2B - Corporativo',
    monthlyReach: '8.000.000',
    regions: 'Nacional',
    website: 'www.globalmidia.com.br',
    ...
    if (app === 'google') {
      ...
      const { data, error } = await supabase.auth.signInWithOAuth({
        ...
        options: {
          ...
          redirectTo: `${window.location.origin}/dashboard/agency/settings/profile`
        }
      });
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerActions}>
          <button className={styles.previewBtn}>
            ...
            <span>Ver Apresentação Pública</span>
          </button>
          ...
          {activeSection === 'identidade' && (
            <section className={styles.sectionCard}>
              ...
              <div className={styles.uploadGroup}>
                <label>Imagem de Capa (Apresentação)</label>
