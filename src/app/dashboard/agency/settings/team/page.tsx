...
import { UserPlus, Mail, Shield, Trash2, CheckCircle, Search, MoreVertical, X, ShieldCheck, Settings, Lock, Users, FileText, Video, MessageSquare, Building2, Zap, DollarSign, Target, UserCircle } from 'lucide-react';
import styles from './page.module.css';

export default function TeamPage() {
  const [activeTab, setActiveTab] = useState<'users' | 'permissions' | 'profile'>('users');
    ...
    try {
      const response = await fetch('/api/admin/create-user', {
        ...
        body: JSON.stringify({
          ...newUser,
          userType: 'agency',
          companyId: 'AGENCY_ID' // In a real app, this comes from the current user's profile
        })
      });
